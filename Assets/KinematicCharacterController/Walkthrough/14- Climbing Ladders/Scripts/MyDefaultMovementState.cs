    ...
    public class MyDefaultMovementState : MyMovementState
    {
        ...
        public override void UpdateVelocity(ref Vector3 currentVelocity, float deltaTime)
        {
            ...
            if (KinematicCharacterMotor.IsStableOnGround)
            {
                ...
                Vector3 inputRight = Vector3.Cross(AssignedCharacterController.WorldspaceCharacterPlaneMoveInputVector, KinematicCharacterMotor.CharacterUp);
                Vector3 reorientedInput = Vector3.Cross(KinematicCharacterMotor.GroundNormal, inputRight).normalized * AssignedCharacterController.WorldspaceCharacterPlaneMoveInputVector.magnitude;
            ...
            {
                if (AssignedCharacterController.WorldspaceCharacterPlaneMoveInputVector.sqrMagnitude > 0f)
                {
                    // If we want to move, add an acceleration to the velocity
                    targetMovementVelocity = AssignedCharacterController.WorldspaceCharacterPlaneMoveInputVector * MaxAirMoveSpeed;
