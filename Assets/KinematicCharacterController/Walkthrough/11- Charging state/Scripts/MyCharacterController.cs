...
namespace KinematicCharacterController.Walkthrough.ChargingState
{
    public class MyCharacterController : BaseCharacterController
    {
        ...
        public void SetInputs(Vector3 cameraOrientedInputVector, Vector3 targetLookDirection)
        {
            ...
            WorldspaceMoveInputVector = Vector3.ProjectOnPlane(cameraOrientedInputVector, KinematicCharacterMotor.CharacterUp).normalized * cameraOrientedInputVector.magnitude;
